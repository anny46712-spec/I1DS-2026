...
console.log("OlNome; ", nome, "Idade: ", idade, "Salário: ", salario); 
...
/* 
     ...
     Retornar 'tue' ou 'false' | Verdadeiro ou Falso
*/
...
/*
        ...
        || (OR "OU") -> Retornar verdadeiro se ao uma das clausulas forem verdadeiras
